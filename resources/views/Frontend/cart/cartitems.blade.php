        ...
        <tr>
          ...
          <td>
            <div class="input-append">
                <input class="span1" style="max-width:34px" value="{{(isset($cartitem['quantity'])?$cartitem['quantity']:'')}}"  id="appendedInputButtons" size="16" type="text">
                ...
                <button class="btn btn-danger btnItemDelete" data-cartid="{{$cartitem['id']}}" type="button"><i class="icon-remove icon-white"></i></button>
                </div>
          </td>
