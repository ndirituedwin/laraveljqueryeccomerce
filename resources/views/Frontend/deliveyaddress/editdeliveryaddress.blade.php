...
<div class="span9">
	...
	<div class="row">
		<div class="span4">
			...
			<form action="{{ route('delivery.edit',$deliveryaddress['id']) }}" method="POST" id="deliveryaddressform">
				@csrf
                <div class="control-group{{$errors->has('name')?' has-error  text-danger':''}}">
                    <label for="name" class="control-label" > Name</label>
                    <div class="controls">
                      <input class="span3"  type="text" value="{{$deliveryaddress['name']}}" id="name" name="name" placeholder="first name">
                  ...
                  <div class="control-group{{$errors->has('address')?' has-error  text-danger':''}}">
                    ...
                    <div class="controls">
                   <textarea name="address" id="address" class="span3"   rows="3" >{{$deliveryaddress['address']}}</textarea>
                  ...
                  <div class="control-group{{$errors->has('city')?' has-error  text-danger':''}}">
                    ...
                    <div class="controls">
                      <input type="text" name="city" class="span3" id="city" placeholder="city" value="{{$deliveryaddress['city']}}">
                        @if ($errors->has('city'))
                  ...
                  <div class="control-group{{$errors->has('state')?' has-error  text-danger':''}}">
                    ...
                    <div class="controls">
                      <input type="text" name="state" class="span3" id="state" placeholder="state" value="{{$deliveryaddress['state']}}">
                        @if ($errors->has('state'))
				...
				<div class="controls">
                    <select name="country" id="country" class="span3">
                        <option value="0">Select</option>
                         ...
                         <option value="{{$country['country_name']}}"@if ($country['country_name']==$deliveryaddress['country'])
              ...
              <div class="control-group{{$errors->has('pincode')?' has-error  text-danger':''}}">
				...
				<div class="controls">
                  <input type="text" class="span3" name="pincode" id="pincode" placeholder="pincode" value="{{Request::old('pincode')?:$deliveryaddress['pincode']}}">
			  ...
			  @endif <br>
                  ...
                  <div class="control-group{{$errors->has('mobile')?' has-error  text-danger':''}}">
                    ...
                    <div class="controls">
                   <input type="text" class="span3"  name="mobile" id="mobile" value="{{Request::old('mobile')?:$deliveryaddress['mobile']}}"   class="form-control"/>
