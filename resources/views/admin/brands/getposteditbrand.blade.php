    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <form action="{{ route('brand.edit',$brand) }}" method="POST" role="form" enctype="multipart/form-data">
          @csrf
            <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                  <div class="form-grop{{$errors->has('brand')?' has-error text-danger':''}}">
                      ...
                      <input type="text" name="brand" value="{{Request::old('brand')?:$brand->brand}}" id="brand" class="form-control" placeholder="enter a brand">
                      @if ($errors->has('brand'))
