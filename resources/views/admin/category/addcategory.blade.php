            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-grop{{$errors->has('categoryname')?' has-error text-danger':''}}">
                      ...
                      <input type="text" name="categoryname" value="{{Request::old('categoryname')}}" id="categoryname" class="form-control" placeholder="enter a category">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group{{$errors->has('categorydescription')?' has-error text-danger':''}}">
                    <label for="categorydescription">Category description</label>
                        <textarea class="form-control" name="categorydescription" id="categorydescription" rows="3">{{Request::old('categorydescription')}}</textarea>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group{{$errors->has('categoryurl')?' has-error text-danger':''}}">
                  <label for="categoryurl">Category url</label>
                      <input type="text" name="categoryurl" id="categoryurl" value="{{Request::old('categoryurl')}}" class="form-control" placeholder="enter  categoryurl">
                ...
                <div class="form-group{{$errors->has('metatitle')?' has-error text-danger':''}}">
                    ...
                    <textarea name="metatitle" id="metatitle" rows="3" class="form-control">{{Request::old('metatitle')}}</textarea>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group{{$errors->has('metadescription')?' has-error text-danger':''}}">
                    ...
                    <textarea name="metadescription" id="metadescription" rows="3" class="form-control">{{Request::old('metadescription')}}</textarea>
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group{{$errors->has('metakeyword')?' has-error text-danger':''}}">
                  ...
                  <textarea name="metakeyword" id="metakeyword" rows="3" class="form-control">{{Request::old('metakeyword')}}</textarea>
